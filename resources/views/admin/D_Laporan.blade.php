    ...
    <table class="table table-bordered" style="margin-left: 220px; padding: 20px;">
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <td>{{$l->pesan}}</td>
                <td>
                <a href="{{ url('/delete_Laporan/' . $l->id) }}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
            @endforeach
        </tbody>
...
<div class="d-flex justify-content-center mt-3">
    <nav aria-label="Page navigation">
        <ul class="pagination pagination-sm">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{ $Laporan->previousPageUrl() }}" aria-label="Previous">
            ...
            @if ($Laporan->hasMorePages())
                <li class="page-item">
                    <a class="page-link" href="{{ $Laporan->nextPageUrl() }}" aria-label="Next">
